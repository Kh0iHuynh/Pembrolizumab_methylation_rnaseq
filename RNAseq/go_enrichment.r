...
write.table(summary_up,file = "goanalysis_bp_survival_up.txt",row.names=FALSE, quote = FALSE,sep="\t")
write.table(summary_down,file = "goanalysis_bp_survival_down.txt", row.names=FALSE, quote = FALSE,sep="\t")
...
summary_up = summary(up_go_run)
summary_down= summary(down_go_run)
write.table(summary_up,file = "goanalysis_bp_cohort_up.txt",row.names=FALSE, quote = FALSE,sep="\t")
write.table(summary_down,file = "goanalysis_bp_cohort_down.txt", row.names=FALSE, quote = FALSE,sep="\t")
...
summary_up = summary(up_go_run)
summary_down= summary(down_go_run)
write.table(summary_up,file = "goanalysis_bp_interaction_up.txt",row.names=FALSE, quote = FALSE,sep="\t")
write.table(summary_down,file = "goanalysis_bp_interaction_down.txt", row.names=FALSE, quote = FALSE,sep="\t")
