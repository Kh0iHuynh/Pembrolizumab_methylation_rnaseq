...
file1 <-read.table("deseq_result_cohorta_survival.txt",header = TRUE,sep = "\t",row.names =1)

file2 <-read.table("mann_whitney_methylation_cohorta_result.txt",header = TRUE,sep = " ")
